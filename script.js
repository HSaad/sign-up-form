class FormValidate {
  ...
  const signUpForm = new FormValidate(document.getElementById('signup'), false);
  ...
  const
    ...
    signUpForm.addCustom(password, () => password.value == passwordConfirm.value);
    signUpForm.addCustom(passwordConfirm, () => password.value == passwordConfirm.value);
